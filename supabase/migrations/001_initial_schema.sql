...
insert into categories (name, slug, description) values
  ('UI Components', 'ui-components', 'React, Vue, and framework UI component libraries'),
  ('Developer Tools', 'dev-tools', 'CLI tools, linters, bundlers, and build utilities'),
  ('Data & State', 'data-state', 'State management, data fetching, and caching'),
  ('Design Systems', 'design-systems', 'Design tokens, themes, and component systems'),
  ('Testing', 'testing', 'Test frameworks, assertion libraries, and mocking tools'),
  ('Utilities', 'utilities', 'General-purpose helper libraries'),
  ('AI & ML', 'ai-ml', 'Machine learning, LLM clients, and AI utilities'),
  ('Infrastructure', 'infrastructure', 'Cloud SDKs, deployment tools, and IaC');
